...
function make(style, active, badge, vertical, accessibilityLabel, accessible, hitSlop, onAccessibilityTap, onLayout, onMagicTap, pointerEvents, removeClippedSubviews, testID, accessibilityComponentType, accessibilityLiveRegion, collapsable, importantForAccessibility, needsOffscreenAlphaCompositing, renderToHardwareTextureAndroid, accessibilityTraits, accessibilityViewIsModal, shouldRasterizeIOS, children) {
  return ReasonReact.wrapJsForReason(NativeBase.FooterTab, {
              style: Js_undefined.fromOption(style),
              active: Js_undefined.fromOption(active),
              badge: Js_undefined.fromOption(badge),
              vertical: Js_undefined.fromOption(vertical),
