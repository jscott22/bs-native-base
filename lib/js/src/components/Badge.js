...
function make(style, primary, success, info, warning, danger, accessibilityLabel, accessible, hitSlop, onAccessibilityTap, onLayout, onMagicTap, pointerEvents, removeClippedSubviews, testID, accessibilityComponentType, accessibilityLiveRegion, collapsable, importantForAccessibility, needsOffscreenAlphaCompositing, renderToHardwareTextureAndroid, accessibilityTraits, accessibilityViewIsModal, shouldRasterizeIOS, children) {
  return ReasonReact.wrapJsForReason(NativeBase.Badge, {
