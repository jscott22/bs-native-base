...
function make(style, block, full, primary, transparent, success, danger, warning, info, bordered, rounded, large, small, active, light, dark, accessibilityLabel, accessible, hitSlop, onAccessibilityType, delayLongPress, delayPressIn, delayPressOut, disabled, accessibilityTraits, onLayout, onLongPress, onPress, onPressIn, onPressOut, pressRetentionOffset, activeOpacity, tvParallaxProperties, hasTVPreferredFocus, _) {
  var partial_arg = {
    style: Js_undefined.fromOption(style),
    block: Js_undefined.fromOption(block),
    full: Js_undefined.fromOption(full),
    light: Js_undefined.fromOption(light),
    dark: Js_undefined.fromOption(dark),
  ...
  var partial_arg$1 = NativeBase.Button;
