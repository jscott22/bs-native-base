...
function make(style, block, full, primary, transparent, success, danger, warning, info, bordered, rounded, large, small, active, accessibilityLabel, accessible, hitSlop, onAccessibilityType, delayLongPress, delayPressIn, delayPressOut, disabled, accessibilityTraits, onLayout, onLongPress, onPress, onPressIn, onPressOut, pressRetentionOffset, children) {
