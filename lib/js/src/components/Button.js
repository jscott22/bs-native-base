...
function make(style, block, primary, transparent, success, danger, warning, info, bordered, disabled, rounded, large, small, active, children) {
  ...
  var partial_arg$1 = Props$BsNativeBase.extendTouchableOpacity(/* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0);
  return ReasonReact.wrapJsForReason(NativeBase.Button, (function (param) {
